...
export default function MyInfo() {
  return (
    <div className="flex justify-between mb-16 p-12 mt-28 ">
      <div className="w-[200px] h-[100px] text-3xl font-bold">EQ beats IQ</div>
      <div className="w-1/3 leading-8 text-xl">
